...
public class AssertionMethods extends CommonMethods implements MethodObjects {
     ...
     * @return String
     */
    public void StoreElementText(String accessType, String accessName, String dictionaryKey) {
     ...
     * @param accessName  : String : Locator value
     */
    public void validateElementText(String matchType, String accessType, String actualValue, String accessName) throws TestCaseFailed {
        String elementText = getElementText(accessType, accessName);
        switch (matchType) {
            case "partial-match":
    ...
    public void isOptionFromRadioButtonGroupSelected(String accessType, String by, String option, String accessName, boolean shouldBeSelected) throws TestCaseFailed {
        List<WebElement> radioButtonGroup = getWait().until(ExpectedConditions.presenceOfAllElementsLocatedBy(getObjectBy(accessType, accessName)));
    ...
    public void isOptionFromDropdownSelected(String accessType, String by, String option, String accessName, boolean shouldBeSelected) throws TestCaseFailed {
        ...
        WebElement dropdown = getWait().until(ExpectedConditions.presenceOfElementLocated(getObjectBy(accessType, accessName)));
